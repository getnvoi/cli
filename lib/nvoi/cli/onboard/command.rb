    ...
    module Onboard
      ...
      class Command
        ...
        def setup_scaleway
          ...
          client = External::Cloud::Scaleway.new(secret_key, project_id, zone: zone)
        ...
        def step_domain_provider
          ...
          with_spinner("Validating credentials...") do
        ...
        def step_apps
          ...
          loop do
            ...
            app_config["domain"] = domain unless domain.to_s.empty?
        ...
        def show_summary
          ...
          apps = @data["application"]["app"]&.keys&.join(", ") || "none"
